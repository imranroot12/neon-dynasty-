...
export type EmitterEventGame =
	...
	| { type: 'neonBonusStart'; mode: 'basic' | 'super' | 'hidden'; totalSpins: number }
	| { type: 'neonMysteryReveal'; vaults: string[]; selected: string }
	| { type: 'neonDragonMeter'; value: number }
	| { type: 'neonDragonEvent'; event: string }
	| { type: 'neonBonusComplete'; mode: string; amount: number }
	| { type: 'soundMute'; muted: boolean }
	| { type: 'musicMute'; muted: boolean };
